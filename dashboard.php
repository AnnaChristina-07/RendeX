...
<!-- Footer -->
<footer class="bg-[#23220f] border-t border-[#3e3d2a] pt-16 pb-8 px-4 md:px-10 mt-auto text-white">
...
<div id="dash-social-fab-container" class="relative flex items-center" style="height: 56px;">
    <!-- Social Media Icons (hidden by default, fan out on click) -->
    <a id="dash-social-whatsapp" href="https://wa.me/?text=Check%20out%20RendeX%20-%20Own%20Less.%20Experience%20More!" target="_blank"
       class="dash-social-icon absolute w-12 h-12 rounded-full flex items-center justify-center shadow-lg transition-all duration-300 ease-[cubic-bezier(0.68,-0.55,0.27,1.55)] opacity-0 scale-0"
    ...
    <a id="dash-social-instagram" href="https://www.instagram.com/" target="_blank"
       class="dash-social-icon absolute w-12 h-12 rounded-full flex items-center justify-center shadow-lg transition-all duration-300 ease-[cubic-bezier(0.68,-0.55,0.27,1.55)] opacity-0 scale-0"
    ...
    <a id="dash-social-facebook" href="https://www.facebook.com/" target="_blank"
       class="dash-social-icon absolute w-12 h-12 rounded-full flex items-center justify-center shadow-lg transition-all duration-300 ease-[cubic-bezier(0.68,-0.55,0.27,1.55)] opacity-0 scale-0"
    ...
    <button id="dash-share-fab-btn" onclick="toggleDashSocialFab()" 
        ...
        <svg id="dash-share-icon" class="w-5 h-5 transition-transform duration-300" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
...
<style>
    .dash-social-fab-open #dash-share-icon {
        transform: rotate(45deg);
    }
    .dash-social-fab-open #dash-share-fab-btn {
...
<script>
let dashSocialFabOpen = false;

function toggleDashSocialFab() {
    dashSocialFabOpen = !dashSocialFabOpen;
    const container = document.getElementById('dash-social-fab-container');
    
    const whatsapp = document.getElementById('dash-social-whatsapp');
    const instagram = document.getElementById('dash-social-instagram');
    const facebook = document.getElementById('dash-social-facebook');
    
    if (dashSocialFabOpen) {
        container.classList.add('dash-social-fab-open');
        
        // Fan out in a radial arc pattern
        setTimeout(() => {
        ...
        container.classList.remove('dash-social-fab-open');
...
document.addEventListener('click', function(e) {
    if (dashSocialFabOpen && !e.target.closest('#dash-social-fab-container')) {
        toggleDashSocialFab();
    }
});
</script>
