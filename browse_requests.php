        ...
        <?php else: ?>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <?php foreach ($requests as $req): ?>
                    <div id="request-card-<?php echo $req['id']; ?>" class="bg-white dark:bg-[#1e1e1e] p-7 rounded-[2rem] shadow-lg shadow-gray-200/50 dark:shadow-none border border-gray-100 dark:border-gray-800 flex flex-col h-full hover:scale-[1.01] transition-transform duration-300">
                        ...
                        <div class="pt-0 mt-0 flex gap-3">
                            ...
                            <button type="button" onclick="openShareModal('<?php echo $req['id']; ?>', '<?php echo htmlspecialchars(addslashes($req['item_name'])); ?>', '<?php echo htmlspecialchars(addslashes($req['renter_name'])); ?>')" class="bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 text-black dark:text-white px-4 rounded-xl font-bold flex items-center justify-center transition-colors border border-transparent hover:border-gray-300 dark:hover:border-gray-600" title="Share this request">
